...
//LCD参数
//extern tLcdDevice sLcdDevice;	//管理LCD重要参数
//LCD的画笔颜色和背景色	   
...
void BSP_LCD_Init(void);						//初始化
//void BSP_LCD_ChangeMode(tLcdMode lcdMode);	//更改运行模式(延时函数)
//void BSP_LCD_FontMode(tLcdFontMode LcdFontMode, uint8_t *fontaddr);//更改字库存放的地方

void BSP_LCD_Scan_Dir(uint8_t dir);				//设置屏幕扫描方向
